    ...
    filter(0)
{
    ...
    if(GetBoolArg("-tclnet"))
    {
        QPixmap pix(":/images/wbackground_le");
        this->ui->wall_label->setPixmap(pix);
    }
...
void OverviewPage::on_lv_nodes_clicked()
{
    ...
    if(GetBoolArg("-tclnet"))
        link="http://tattoocoinle.thecryptochat.net/network";
...
// Exchange link | TODO: correct link name in future update
void OverviewPage::on_blk_explorer1_clicked()
{
    QString link="https://novaexchange.com/market/BTC_TATO/";
    if(GetBoolArg("-tclnet"))
        link="https://novaexchange.com/market/BTC_TLE/";
    QDesktopServices::openUrl(QUrl(link));
}
...
void OverviewPage::on_blk_explorer2_clicked()
{
    ...
    if(GetBoolArg("-tclnet"))
        link="http://tattoocoinle.thecryptochat.net/";
    QDesktopServices::openUrl(QUrl(link));
}
...
{
    QString link="http://tattoocoin.net/";
    QDesktopServices::openUrl(QUrl(link));
}
